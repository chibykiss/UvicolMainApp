...
OffLinePaymentFor offLinePaymentFor;
...
class _OfflineState extends State<OfflineScreen> {
  ...
  onPressSubmit() async {
    ...
    loading();
    if (widget.offLinePaymentFor==OffLinePaymentFor.WalletRecharge) {
    ...
    } else if(widget.offLinePaymentFor==OffLinePaymentFor.Order){
