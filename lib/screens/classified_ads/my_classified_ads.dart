...
class _MyClassifiedAdsState extends State<MyClassifiedAds> {
  ...
  getProductList() async {
    var productResponse =
        await ProductRepository().getOwnClassifiedProducts(page: _page);
  ...
  deleteProduct(int id) async {
    loading();
    var response =
        await ProductRepository().getDeleteClassifiedProductResponse(id);
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          elevation: 0,
          title: Text(
            LangText(context).local.my_classified_ads_screen_title,
            style: TextStyle(
                fontSize: 16,
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      LangText(context)
                          .local
                          .my_classified_ads_screen_add_new_products,
                      style: CommonFunctions.dashboardBoxText(context)
                          .copyWith(color: MyTheme.accent_color, fontSize: 12),
                    ),
  ...
  showDeleteWarningDialog(id) {
    showDialog(
        ...
        builder: (context) => Container(
              ...
              child: AlertDialog(
                title: Text(
                  LangText(context).local.common_delete_warning_text,
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 15,
                      color: Colors.red),
                ...
                actions: [
                  TextButton(
                      ...
                      child: Text(
                        LangText(context).local.common_no,
